...
PON VLAN 2510 is mapped to LAN port, passive bridge doesn't work[^first] for me and probably isn't needed.
...
[^first]: Configured on providers OLT, some won't accept frames from MAC address other then ONU itself
